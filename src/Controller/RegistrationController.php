...
use ContainerSiOqgQV\getUsersRepositoryService;
...
class RegistrationController extends AbstractController
{
    ...
    public function resendVerify(JWTService $jwt, SendMailservice $mail, UsersRepository $usersRepository): Response
    {
        $user = $this->getUser();
        if(!$user){
